...
//   // const postBlog = (event) => {
//   //   event.preventDefault();
//   //   database.ref("blogPosts").push(postData, (error) => {
//   //     if (error) {
...
//       <Link to={`/blok`}></Link>
//       <form
//         className="max-w-2xl mx-auto mt-6 p-4 bg-white rounded-lg shadow-md"
...
//             id="body"
//             name="body"
//             placeholder="Blog post body, separated by commas"
//             value={postData.body}
//           ></textarea>
//         </div>
